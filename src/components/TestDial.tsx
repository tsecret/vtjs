...
export const TestDial = () => {
	...
	if (import.meta.env.VITE_DEV !== "true") return null;
	...
	return (
		<div className="fab">
			...
			<button className="btn btn-sm" onClick={() => onGameTrigger("PREGAME")}>
				Trigger PreGame
			</button>
			<button className="btn btn-sm" onClick={() => onGameTrigger("INGAME")}>
				Trigger Game
			</button>
			<button className="btn btn-sm" onClick={() => onGameTrigger("MENUS")}>
				Trigger Match End
			</button>
