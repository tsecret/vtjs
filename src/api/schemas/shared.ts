...
export type PartyResponse = {
	...
	CustomGameData: {
		...
		Membership: {
			teamOne: { Subject: string }[] | null;
			teamTwo: { Subject: string }[] | null;
			teamSpectate: { Subject: string }[] | null;
			teamOneCoaches: { Subject: string }[] | null;
			teamTwoCoaches: { Subject: string }[] | null;
		};
		MaxPartySize: number;
	...
	ErrorNotification: {
		ErrorType: string;
		ErroredPlayers: { Subject: string }[] | null;
	};
